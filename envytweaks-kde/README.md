...
KDE Plasma widget to change the GPU mode using the [EnvyTweaks](https://github.com/esfingex/envytweaks) command line tool.

## Install

### Dependencies

- This widget depends on [EnvyTweaks](https://github.com/esfingex/envytweaks), so you must install it first.
