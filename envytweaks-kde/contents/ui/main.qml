...
PlasmoidItem {
    ...
    // Keep notifications open because EnvyTweaks operations can take several seconds to complete.
    // This option is only valid for the notify-send tool.
    property string const_ZERO_TIMEOUT_NOTIFICATION: "-t 0"

    // GPU modes available for the EnvyTweaks tool.
    ...
    // Whether or not the EnvyTweaks tool is installed. Assume by default that it is installed, however it is checked in onCompleted().
    property bool envytweaks: true
    ...
    Connections {
        ...
        function onExited(exitCode, exitStatus, stdout, stderr){
            if (stderr) {
                ...
                * Perhaps in the process, EnvyTweaks switched to another mode automatically without warning.
    ...
    Connections {
        ...
        function onExited(exitCode, exitStatus, stdout, stderr){
            ...
            if (stderr) {
                ...
                // Check the current state in case EnvyTweaks made changes without warning.
                queryMode()
                return
            }
            ...
            * In this scenario, do the changes that EnvyTweaks can make really require a reboot? In the end without a reboot,
    ...
    fullRepresentation: Item {
        ...
        ColumnLayout {
            ...
            PlasmaComponents3.Label {
                Layout.alignment: Qt.AlignCenter
                text: root.envytweaks ? i18n("%1 currently in use.", root.currentGPUMode.toUpperCase()) : i18n("EnvyTweaks is not working.")
            }
            ...
            PlasmaComponents3.ComboBox {
                ...
                enabled: !root.loading && root.envytweaks
    ...
    toolTipSubText: root.envytweaks ? i18n("%1 currently in use.", root.currentGPUMode.toUpperCase()) : i18n("EnvyTweaks is not working.")
}
